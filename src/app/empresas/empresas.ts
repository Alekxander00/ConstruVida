...
export class Empresas {
  companies = [
    {
      id: 1,
      name: 'Construcciones del Norte S.A.S',
    ...
    {
      id: 2,
      name: 'Ingeniería y Obras Civiles',
    ...
    {
      id: 3,
      name: 'Arquitectura Moderna Ltda',
      specialty: 'Diseño y Construcción',
      description: 'Fusionamos diseño arquitectónico innovador con construcción de calidad superior.'
    },
    {
      id: 4,
      name: 'Constructora Industrial Pro',
      specialty: 'Construcción Industrial',
